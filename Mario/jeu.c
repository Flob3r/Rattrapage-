...
void jouer(SDL_Surface* ecran)
{
    ...
    mur = IMG_Load("naruto_ville.gif");
    caisse = IMG_Load("livre.gif");
    caisseOK = IMG_Load("book.gif");
    objectif = IMG_Load("chest.gif");
    mario[BAS] = IMG_Load("naruto_bas.gif");
    mario[GAUCHE] = IMG_Load("naruto_gauche.gif");
    mario[HAUT] = IMG_Load("naruto_haut.gif");
    mario[DROITE] = IMG_Load("naruto_droite.gif");
